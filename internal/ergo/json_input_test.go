...
func TestTaskInput_ValidateForNewTask(t *testing.T) {
	tests := []struct {
		...
		{
			name:        "valid minimal",
			input:       TaskInput{Title: ptr("Do something"), Body: ptr("Do something")},
			expectError: false,
		},
		{
		...
		{
			name:        "missing title",
			input:       TaskInput{Body: ptr("Has body")},
			expectError: true,
		...
		{
			name:        "empty title",
			input:       TaskInput{Title: ptr(""), Body: ptr("body")},
			expectError: true,
			missing:     []string{"title"},
		},
		{
		...
		{
			name:        "invalid state",
			input:       TaskInput{Title: ptr("X"), Body: ptr("X"), State: ptr("running")},
			expectError: true,
		...
		},
		{
			...
			input:       TaskInput{Title: ptr("X"), Body: ptr("X"), State: ptr("doing"), Claim: ptr("agent-1")},
			expectError: false,
		},
		{
		...
		},
		{
			...
			input:       TaskInput{Title: ptr("X"), Body: ptr("X"), ResultPath: ptr("docs/x.md")},
			expectError: true,
			invalidKeys: []string{"result_summary"},
		},
		{
			name:        "result_summary without result_path",
			input:       TaskInput{Title: ptr("X"), Body: ptr("X"), ResultSummary: ptr("Summary")},
			expectError: true,
			invalidKeys: []string{"result_path"},
		},
		{
			name:        "result_path and result_summary together",
			input:       TaskInput{Title: ptr("X"), Body: ptr("X"), ResultPath: ptr("docs/x.md"), ResultSummary: ptr("Summary")},
			expectError: false,
		},
	}
